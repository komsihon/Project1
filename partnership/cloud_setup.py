...
def deploy(app, member, project_name, billing_plan, monthly_cost,
    ...
    subprocess.call(['mongorestore', '-d', database, CLOUD_FOLDER + '000Tpl/DB/000Default'])
    ...
    config = PartnerProfile(service=service, is_pro_version=is_pro_version,
